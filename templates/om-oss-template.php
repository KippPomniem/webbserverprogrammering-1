...
<html lang="sv">
	<head>
		...
		<link href="stylesheet" rel="laxhjalpen.css" />
	</head>
		...
		<div role="main">
		  <article class="block">
			<figure class="alignleft">
			  <img src="https://www.datanom.ax/~42209/webbserverprogrammering-1/templates/pexels-photo-604706.png" alt="Det här är jag - Mia"> 
		  ...
		  <article class="block">
			<figure class="alignleft">
				<img src="https://www.datanom.ax/~42209/webbserverprogrammering-1/templates/boy-1293959_960_720.png" alt="Det här är jag - Pelle"> 
				<figcaption class="bildcaption double">
				  Pelle
				</figcaption>
			</figure>
		  ...
		  <article class="block">
			<figure class="alignleft">
				<img src="https://www.datanom.ax/~42209/webbserverprogrammering-1/templates/avatar-people-person-business-user-woman-1447677-pxhere.com.jpg" alt="Det här är jag - Petra"> 
				<figcaption class="bildcaption double">
				  Petra
				</figcaption>
			</figure>
		  ...
		  <article class="block">
			<figure class="alignleft">
				<img src="https://www.datanom.ax/~42209/webbserverprogrammering-1/templates/3b4.png" alt="Det här är jag - Johan"> 
				<figcaption class="bildcaption double">
				  Johan
				</figcaption>
			</figure>
